...
public class CredentialService {
    ...
    public Credential getCredentialForUserByCredentialId(String username, Integer credentialId){
        return credentialMapper.getCredentialForUserByCredentialId(username, credentialId);
    }
